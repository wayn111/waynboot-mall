...
public interface IPayService {
     ...
     * @return r
     */
    WxPayMpOrderResult prepay(String orderSn, Integer payType, Long userId, HttpServletRequest request);
     ...
     * @return r
     */
    Object h5pay(OrderVO orderVO) throws UnsupportedEncodingException;
     ...
     * @return r
     */
    void refund(Long orderId) throws UnsupportedEncodingException, AlipayApiException, WxPayException;
